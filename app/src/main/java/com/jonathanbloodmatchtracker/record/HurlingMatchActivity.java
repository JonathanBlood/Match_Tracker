...
/**
 * This class is responsible for the recording of Hurling matches.
 *
 * @author Jonathan
 */
public class HurlingMatchActivity extends Activity {

    private static final String SPORT   = "Hurling";
    ...
    private TextView team1GoalTV;
    private TextView team2GoalTV;
    private TextView team1PointTV;
    private TextView team2PointTV;
    ...
    private int team1GoalCount = 0;
    private int team1PointCount = 0;
    private int team2OverallScore = 0;
    private int team2GoalCount = 0;
    private int team2PointCount = 0;

    private ArrayList<MatchEvent> matchEvents; // Used to store the match events.
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hurling_match);

        //Set Dashboard title
        TextView dashboardTitle = (TextView) findViewById(R.id.dashboard_title);
        dashboardTitle.setText(getString(R.string.hurling_activity));
        ...
        TextView team1NameTV    = (TextView) this.findViewById(R.id.team1NameTVHM);
        team1GoalTV             = (TextView) this.findViewById(R.id.team1GoalTVHM);
        team1PointTV            = (TextView) this.findViewById(R.id.team1PointTVHM);
        ...
        TextView team2NameTV    = (TextView) this.findViewById(R.id.team2NameTVHM);
        team2GoalTV             = (TextView) this.findViewById(R.id.team2GoalTVHM);
        team2PointTV            = (TextView) this.findViewById(R.id.team2PointTVHM);
        ...
        onePlayerEventDG = new Dialog(HurlingMatchActivity.this);
        ...
        twoPlayerEventDG = new Dialog(HurlingMatchActivity.this);
        ...
        // Timer elements
        startBn     = (BootstrapButton) this.findViewById(R.id.startButtonHM);
        matchChron  = (Chronometer) findViewById(R.id.chronometerHM);
        stopBn      = (BootstrapButton) this.findViewById(R.id.stopButtonHM);
        ...
        Spinner matchEventSpinner           = (Spinner) findViewById(R.id.matchEventSpinnerHM);
        ArrayAdapter<CharSequence> adapter  = ArrayAdapter.createFromResource(this, R.array.HurlingMatchEvent_array, android.R.layout.simple_spinner_item);
        ...
        matchInfoTV     = (TextView) this.findViewById(R.id.matchInfoTVHM);
        undoEventBn     = (BootstrapButton) this.findViewById(R.id.undoEventButtonHM);
        finishMatchBn   = (BootstrapButton) this.findViewById(R.id.finishMatchHM);
    ...
    private void finishMatchButton() {
        finishMatchBn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(HurlingMatchActivity.this, MainMenuActivity.class);
        ...
        if (team.equals(teamExists) && SPORT.equals(sportExistsForGivenTeam)) {
            ...
            switch (status) {
                ...
                case DRAW:
                    ...
                    break;
                default:
                    teamAdapter.addTeam(team, SPORT, 0, 1, 0, 0); // Team lost the game.
                    break;
            }
        }
    }
    ...
    /**
     * If undo button is called and type == goal then undo the score for the
     * team.
     *
     * @param aTeam team
     */
    ...
    /**
     * If undo button is called and type == point then undo the score for the
     * team.
     *
     * @param aTeam team
     */
    ...
    private void playAlarm() {
        MediaPlayer mp = MediaPlayer.create(HurlingMatchActivity.this, R.raw.buzzer);
        mp.start();
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.home_button:
                    i = new Intent(HurlingMatchActivity.this, MainMenuActivity.class);
                    i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    break;
            }
            if (i != null) {
    ...
    private class SpinnerItemSelectedListener implements OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
            ...
            if(pos != 0) {
                ...
                if (getString(R.string.event_substitution).equals(eventType) || getString(R.string.event_blackcard).equals(eventType)) {
