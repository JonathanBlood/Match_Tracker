...
public class GaelicMatchActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dashboardTitle.setText(getString(R.string.gaelic_activity));
        ...
        TextView team1NameTV    = (TextView) this.findViewById(R.id.team1NameTVGM);
        ...
        TextView team2NameTV    = (TextView) this.findViewById(R.id.team2NameTVGM);
        ...
        // Timer elements
        startBn     = (BootstrapButton) this.findViewById(R.id.startButtonGM);
        stopBn      = (BootstrapButton) this.findViewById(R.id.stopButtonGM);
        ...
        Spinner matchEventSpinner           = (Spinner) findViewById(R.id.matchEventSpinnerGM);
        ArrayAdapter<CharSequence> adapter  = ArrayAdapter.createFromResource(this, R.array.GaelicMatchEvent_array, android.R.layout.simple_spinner_item);
        ...
        undoEventBn     = (BootstrapButton) this.findViewById(R.id.undoEventButtonGM);
        finishMatchBn   = (BootstrapButton) this.findViewById(R.id.finishMatchGM);
        ...
        undoEventBn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (matchEvents.size() >= 1) {
                    ...
                    // score.
                    if (getString(R.string.event_point).equals(aMatchEvent.getType())) {
     ...
     *
     * @param teamAdapter team adapater
     * @param team team
