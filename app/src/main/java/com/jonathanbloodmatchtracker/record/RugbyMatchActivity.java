...
public class RugbyMatchActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dashboardTitle.setText(getString(R.string.rugby_activity));
        ...
        TextView team1NameTV    = (TextView) this.findViewById(R.id.team1NameTVRM);
        team1ScoreTV            = (TextView) this.findViewById(R.id.team1GoalTVRM);
        TextView team2NameTV    = (TextView) this.findViewById(R.id.team2NameTVRM);
        ...
        // Timer elements
        startBn     = (BootstrapButton) this.findViewById(R.id.startButtonRM);
        stopBn      = (BootstrapButton) this.findViewById(R.id.stopButtonRM);
        ...
        Spinner matchEventSpinner           = (Spinner) findViewById(R.id.matchEventSpinnerRM);
        ArrayAdapter<CharSequence> adapter  = ArrayAdapter.createFromResource(this, R.array.RugbyMatchEvent_array, android.R.layout.simple_spinner_item);
        ...
        undoEventBn     = (BootstrapButton) this.findViewById(R.id.undoEventButtonRM);
        finishMatchBn   = (BootstrapButton) this.findViewById(R.id.finishMatchRM);
    ...
    private void onePlayerEventDialogSetup() {
        ...
        createMatchEventBN.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // If try, conversion, penalty, drop goal event update GUI to display new score.
                if (eventType.equals(getString(R.string.event_try))) {
                    updateTryScore(eventTeamSel);
                } else if (eventType.equals(getString(R.string.event_conversion))) {
                    updateConversionScore(eventTeamSel);
                } else if (eventType.equals(getString(R.string.event_penalty))) {
                    updatePenaltyScore(eventTeamSel);
                } else if (eventType.equals(getString(R.string.event_dropgoal))) {
        ...
        undoEventBn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (matchEvents.size() >= 1) {
                    ...
                    // Check if the event is a try, conversion, penalty, dropgoal so we can then undo the score.
                    if (getString(R.string.event_try).equals(aMatchEvent.getType())) undoTryScore(aMatchEvent.getTeam());
                    else if (getString(R.string.event_conversion).equals(aMatchEvent.getType()))
                        undoConversionScore(aMatchEvent.getTeam());
                    else if (getString(R.string.event_penalty).equals(aMatchEvent.getType()))
                        undoPenaltyScore(aMatchEvent.getTeam());
                    else if (getString(R.string.event_dropgoal).equals(aMatchEvent.getType()))
    ...
    /**
     * If undo button is called and type == try then undo the score for the
     * team.
     *
     * @param aTeam team
     */
    ...
    /**
     * If undo button is called and type == conversion then undo the score for
     * the team.
     *
     * @param aTeam team
     */
    ...
    /**
     * If undo button is called and type == penalty then undo the score for the
     * team.
     *
     * @param aTeam team
     */
    ...
    /**
     * If undo button is called and type == drop goal then undo the score for
     * the team.
     *
     * @param aTeam team
     */
