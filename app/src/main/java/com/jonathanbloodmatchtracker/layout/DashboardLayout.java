/*
* NOT MY CODE IMPLEMENTS DASHBOARD LAYOUT FOR DASHBOARD DESIGN PATTERN
...
package com.jonathanbloodmatchtracker.layout;
...
/**
 * Custom layout that arranges children in a grid-like manner, optimising for even horizontal and
 * vertical whitespace.
 */
public class DashboardLayout extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        // Calculate what number of rows and columns will optimise for even horizontal and
