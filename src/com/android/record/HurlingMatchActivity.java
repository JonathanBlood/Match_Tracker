...
public class HurlingMatchActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		team1NameTV = (TextView) this.findViewById(R.id.team1NameTVHM);
		...
		team2NameTV = (TextView) this.findViewById(R.id.team2NameTVHM);
		...
		noteDG = new Dialog(HurlingMatchActivity.this);
		noteDG.setContentView(R.layout.note_dialog);
		noteDG.setTitle("Add note: ");
		noteDG.setCancelable(true);
		this.noteDialogSetup();
				
		addNoteBn = (ImageButton) findViewById(R.id.addNoteHM);
		this.addNoteButton();

		matchEvents = new ArrayList<MatchEvent>();

		// Timer elements
		startBn = (ImageButton) this.findViewById(R.id.startButtonHM);
		this.startButton();
		stopBn = (ImageButton) this.findViewById(R.id.stopButtonHM);
		...
		matchEventSpinner = (Spinner) findViewById(R.id.matchEventSpinnerHM);
		ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.HurlingMatchEvent_array,
		...
		undoEventBn = (ImageButton) this.findViewById(R.id.undoEventButtonHM);
		this.undoEventButton();
		finishMatchBn = (ImageButton) this.findViewById(R.id.finishMatchHM);
	...
	private class ActionBarClickListener implements OnClickListener
	{
		...
		public void onClick(View v)
		{
			...
			case R.id.login_button:
				...
				{
					i = new Intent(HurlingMatchActivity.this, LoginActivity.class);
				}
				break;
			case R.id.sync_button:
				...
				if (!serviceSsettings.getBoolean("serviceStarted", false))
				{
					...
					Intent syncIntent = new Intent(HurlingMatchActivity.this, SyncService.class);
