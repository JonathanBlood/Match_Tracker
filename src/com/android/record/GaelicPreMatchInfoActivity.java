 ...
 * 
 */
public class GaelicPreMatchInfoActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.gaelic_pre_match_info);
		...
		team1AutoTV = (AutoCompleteTextView) findViewById(R.id.team1AutoTVGaelic);
		team1AutoTV.setAdapter(teamAdapter);

		// Team2 text view and input set up.
		team2AutoTV = (AutoCompleteTextView) findViewById(R.id.team2AutoTVGaelic);
		team2AutoTV.setAdapter(teamAdapter);

		// Venue input.
		venueAutoTV = (AutoCompleteTextView) findViewById(R.id.venueAutoTVGaelic);
		...
		numOfPlayersET = (EditText) this.findViewById(R.id.numOfPlayersETGaelic);

		// Minutes per half input.
		minutesPerHalfET = (EditText) this.findViewById(R.id.minutesPerHalfETGaelic);

		// Referee input
		refereeNameAutoET = (AutoCompleteTextView) findViewById(R.id.refereeNameAutoTVGaelic);
		refereeNameAutoET.setAdapter(refereeAdapter);

		// Type input selection
		friendlyRadioBN = (RadioButton) this.findViewById(R.id.friendlyRadioBNGaelic);
		leagueRadioBN = (RadioButton) this.findViewById(R.id.leagueRadioBNGaelic);
		cupRadioBN = (RadioButton) this.findViewById(R.id.cupRadioBNGaelic);
		...
		leagueCupNameAutoTV = (AutoCompleteTextView) findViewById(R.id.leagueCupNameAutoTVGaelic);
		...
		createMatchBN = (Button) this.findViewById(R.id.createMatchBNGaelic);
	...
	private class ActionBarClickListener implements OnClickListener
	{
		...
		public void onClick(View v)
		{
			...
			case R.id.home_button:
				i = new Intent(GaelicPreMatchInfoActivity.this, MainMenuActivity.class);
			...
			case R.id.login_button:
				...
				{
					i = new Intent(GaelicPreMatchInfoActivity.this, LoginActivity.class);
				}
				break;
			case R.id.sync_button:
				...
				if (!serviceSsettings.getBoolean("serviceStarted", false))
				{
					...
					Intent syncIntent = new Intent(GaelicPreMatchInfoActivity.this, SyncService.class);
		...
		createMatchBN.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				if (validateForm())
				{
					...
					Intent matchIntent = new Intent(GaelicPreMatchInfoActivity.this, GaelicMatchActivity.class);
