...
public class BaseHelper extends SQLiteOpenHelper
{
	...
	/**
	 * Upgrade database by increasing DATABASE_VERSION number. This method upgrades the database by dropping the tables
	 * and creating them again.
	 */
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion)
	{
		Log.w("DATABASE", "Upgrading database from version " + oldVersion + " to " + newVersion);
		db.execSQL("ALTER TABLE Facts ADD note text");
	}
